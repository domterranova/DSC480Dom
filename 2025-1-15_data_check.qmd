...
Prints 185,297, indicating there are 185,297 coverage days for Unicare members in the study pre Ibis admission
```{r}
sum(report_full$covered_days_pre_ibis[report_full$org_name == "Unicare - Study"])
```

Prints 30,231, indicating there are 30,231 coverage days for Unicare members in the study post Ibis admission
```{r}
sum(report_full$covered_days_post_ibis[report_full$org_name == "Unicare - Study"])
```

Prints 903,546, indicating there are 903,546 coverage days for all members pre Ibis admission
```{r}
sum(report_full$covered_days_pre_ibis)
```

Prints 152,527, indicating there are 152,527 coverage days for all members post Ibis admission
```{r}
...
\#### admits pre/post
Create data with admission count
```{r}
